...
function AdminStatsTypeToday() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${backendLink}/orders/admin/todaySales?todayDate=${todayDate}`)
      .then((res) => {
        let tot = 0;
  ...
  return (
    <Box w="100%">
      ...
      >
        ...
        <Box w="80%">
          <Barchart
            name={"Today's Sales By Qty"}
            TodayBarDataByQty={[phone, laptop, men, women, home]}
            todayText={"Today's Sales In Different Categories"}
...
export default AdminStatsTypeToday;
